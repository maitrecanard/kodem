...
export default function Challenge() {
    ...
    return (
        <AdminLayout title="Vérification 2FA">
            <div className="bg-white rounded-lg border border-brume p-6 shadow-sm max-w-md">
                ...
                <form onSubmit={submit} className="mt-6">
                    <input
                        ...
                        className="block w-full border border-cobalt-200 rounded px-3 py-2 font-mono text-lg tracking-widest"
                    />
